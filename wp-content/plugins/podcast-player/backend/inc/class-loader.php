...
class Loader {
	...
	public function admin_notices() {
		...
		if ( defined( 'PP_PRO_VERSION' ) && version_compare( PP_PRO_VERSION, '4.3.0', '<' ) ) {
			?>
			<div class="notice-warning notice is-dismissible pp-welcome-notice">
				<p><?php esc_html_e( 'There is an update available to Podcast Player Pro. Please update to Podcast Player Pro v4.3.0. If you have not received an automated update notice, please login to vedathemes.com and download latest version.', 'podcast-player' ); ?></p>
			</div>
			<?php
		}
	}
