...
<div class="n_differentfullLegacyInner">
   ...
   <div class="row n_cont">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 n_noIm">
        <img class="n_workImage" src="<?php echo get_template_directory_uri(); ?>/images/canberra2-min.jpeg" alt="">
        <img class="n_workImage" src="<?php echo get_template_directory_uri(); ?>/images/partner.jpeg" alt="">
